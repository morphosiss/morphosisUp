...
export default function Home() {
  return (
    <div>
      <header className="py-4 back h-screen ">
        <div className="flex items-center justify-around w-full">
          <div>
            <Link href={"/"} className="flex items-center gap-1">
              ...
              <span className="text-2xl font-semibold text--600">morphose</span>
            </Link>
          </div>
          ...
          <div>
            <button className="flex items-center gap-2 text-[15px] font-medium py-2 px-5 rounded-lg bg-indigo-500 text-white">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="none"
