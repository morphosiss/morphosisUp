  ...
  setShowMenu
    ...
    return (
      ...
      initial="hidden" whileInView="visible"
        ...
        <Banner />
        <motion.section variants={itemVariantsInfiniteScroll} className="z-20 relative w-full left-0 right-0 flex items-start mt-14 gap-10">
        ...
        <motion.section id="banner" className="relative pt-32">
          <motion.div
            ...
            <motion.div className="grid mt-14  pb-5 grid-cols-1 px-5 ret:grid-cols-2 gap-2">
              <motion.div variants={itemVariants} className="p-5 rounded-xl  bg-white border border-gray-200">
                <header>
                  <span>
                    <svg
              ...
              {/* OBJECTIVOS */}
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: false, margin: "-100px" }} variants={itemVariants} className="p-5 rounded-xl  bg-white border border-gray-200">
                <header>
                  <span>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
