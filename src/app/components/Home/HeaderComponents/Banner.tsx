  ...
  return (
    <section className="pot:pt-40 pt-32 relative">
      <motion.div
        ...
        <motion.h1 variants={itemVariants} className="det:text-[5rem] ret:text-5xl smaller:text-4xl text-4xl pot:text-7xl font-medium pot:font-semibold leading-none">
        ...
        <div className="mt-5 max-w-2xl w-full m-auto">
          ...
          <motion.div variants={itemVariants}  className="flex ret:flex-row flex-col max-w-[25rem] gap-1 m-auto mt-10 w-full">
            <button
